<%@ Page Title="" Language="C#" MasterPageFile="~/Solution/Code/HTML/Main.Master" AutoEventWireup="true" CodeBehind="CitizenVote.aspx.cs" Inherits="Voting_System.Solution.Code.HTML.CitizenVote" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container_2 pb-3">
        <center>
            <h1 id="capt">Vote for Metropolitan</h1>
        </center>
        <hr id="horizontal1" />
        <div>
            <center>
...
<%--                         <asp:TemplateField ItemStyle-HorizontalAlign="Center"
                            ...
                            <HeaderTemplate>
                                <center>
                                    ...
                                    <h7 style="color: white !important">Your ID</h7>
                                </center>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <asp:Textbox runat="server" ID="C_ID" Width="100px" Height="20px" PlaceHoder="Enter ID Number"></asp:Textbox>
                            </ItemTemplate>
                        </asp:TemplateField>--%>
                    </Columns>
                    ...
                    <SortedDescendingHeaderStyle BackColor="#383838" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DDBASE %>" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [Admin]">
                     <SelectParameters>
